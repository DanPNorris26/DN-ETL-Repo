...
***************************************************************************************************************/
        private static void Excercise1()
        {
            ...
            farm.Enter(new Cow(4));
            farm.Enter(new Hen(2));
            farm.Enter(new Horse(4));
            farm.Enter(new Sheep(4));
 ...
 *****************************************************************************************************************/
        private static void Excercise2()
        {
            ...
            //While reviewing, decided to reduce code and create object directly as parameter.
            ////Helps a bit with readability and doesn't affect the output after my changes
            farm.Enter(new Cow(4));
            farm.Enter(new Hen(2));
            farm.Enter(new Horse(4));
            farm.Enter(new Sheep(4));
